...
private:
	...
	std::shared_ptr<frc::JoystickButton> buttonA;
	std::shared_ptr<frc::JoystickButton> buttonB;
	std::shared_ptr<frc::JoystickButton> buttonX;
	std::shared_ptr<frc::JoystickButton> buttonY;
public:
	OI();
