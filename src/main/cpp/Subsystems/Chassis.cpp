...
Chassis::Chassis() : frc::Subsystem("Chassis") {
    ...
    leftA.reset(new frc::Spark(3));
    leftB.reset(new frc::Spark(4));
    leftC.reset(new frc::Spark(5));
    leftMotors = std::make_shared<frc::SpeedControllerGroup>(*leftA, *leftB , *leftC );
    rightA.reset(new frc::Spark(0));
    rightB.reset(new frc::Spark(1));
    rightC.reset(new frc::Spark(2));
