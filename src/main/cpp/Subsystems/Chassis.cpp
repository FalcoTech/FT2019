...
Chassis::Chassis() : frc::Subsystem("Chassis") {
    ...
    */
    leftA.reset(new frc::Spark(0));
    leftB.reset(new frc::Spark(1));
    leftMotors = std::make_shared<frc::SpeedControllerGroup>(*leftA, *leftB);
    rightA.reset(new frc::Spark(2));
    rightB.reset(new frc::Spark(3));
    rightMotors = std::make_shared<frc::SpeedControllerGroup>(*rightA, *rightB);
